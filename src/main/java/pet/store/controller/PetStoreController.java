...
public class PetStoreController {
	...
	public PetStoreEmployee insertEmployee(@PathVariable Long petStoreId,
		...
		log.info("Creating pet store employee {} at pet store {}", petStoreEmployee, petStoreId);
		return petStoreService.saveEmployee(petStoreId, petStoreEmployee);
	}
	
	@PutMapping("/pet_store/{petStoreId}/employee/{employeeId}")
	public PetStoreEmployee updateEmployee(@PathVariable Long employeeId,
			@RequestBody PetStoreEmployee petStoreEmployee) {
		petStoreEmployee.setEmployeeId(employeeId);
		Long petStoreId = petStoreEmployee.getEmployeeId();
	...
	public PetStoreCustomer addPetStoreCustomer(@PathVariable Long petStoreId,
		...
		log.info("Creating pet store customer {} at pet store {}", petStoreCustomer, petStoreId);
